      ...
      <Router>
        ...
        <div className="div__nav">
          <span className="header__background">
            <img src="img/header-circle.svg" alt="" className="header__image" />
          </span>
          <header className="section">
            <div className="section-full wrap size-80">
              <div className="nav-main">
                ...
                <img src={Logo} alt="Robert logo" className="nav-main__logo" />
                <input type="checkbox" id="show-menu" role="button" />
                <ul className="nav-main__menu fadeInUp" id="menu">
                  <li className="nav-main__menu-item">
                    <NavLink exact to="/Hero" className="nav-main__menu-item">
                      Home
                    </NavLink>
                  </li>
                  <li className="nav-main__menu-item">
